                    ...
                    <?php if ($canEdit): ?>
                        <div>
                            <div class="section-card">
                                ...
                                <form method="POST" action="../../controllers/products/<?= $editProduct ? 'update' : 'create' ?>.php">
                                    <?= csrf_field() ?>
                                    <?php if ($editProduct): ?>
                            ...
                            <?php if ($editProduct): ?>
                                <div class="section-card">
                                    ...
                                    <?php if (!empty($available)): ?>
                                        <form method="POST" action="../../controllers/products/link_supplier.php" style="display:flex; gap:8px; margin-bottom:16px; align-items:center;">
                                            <?= csrf_field() ?>
                                    ...
                                    <?php if (!empty($linked)): ?>
                                        <?php foreach ($linked as $s): ?>
                                            <div class="linked-supplier">
                                                ...
                                                <form method="POST" action="../../controllers/products/unlink_supplier.php"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($canEdit): ?>
                                                        ...
                                                        <form method="POST" action="../../controllers/products/delete.php" style="display:inline;"
